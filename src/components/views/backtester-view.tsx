...
function summarize(returns: number[], totalBars: number, fast: number, slow: number, sensitivity: Result["sensitivity"], walkForwardResults: Result["walkForwardResults"]): Result {
...
export function BacktesterView() {
  ...
  async function loadAndRun() {
    ...
    try {
      ...
      setBars(nextBars); setResult(summarize(returns, nextBars.length, fastPeriod, slowPeriod, sensitivity, walkForwardResults)); setState("ready");
