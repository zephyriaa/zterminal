/* @ts-self-types="./research_core.d.ts" */

/**
 * @param {any} bars_js
 * @param {any} intents_js
 * @param {any} initial_capital_js
 * @param {any} policy_js
 * @returns {any}
 */
export function replay_wasm(bars_js, intents_js, initial_capital_js, policy_js) {
    const ret = wasm.replay_wasm(bars_js, intents_js, initial_capital_js, policy_js);
    if (ret[2]) {
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('research_core_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
