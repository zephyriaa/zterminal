...
export type ResearchLayerId = "vwap" | "ema" | "profile" | "sessionProfile" | "sessions" | "structure" | "cvd" | "dom" | "tape" | "largePrints" | "footprint" | "flowPulse" | "gex";
...
export const RESEARCH_LAYER_CAPABILITIES: ResearchLayerCapability[] = [
  ...
  { id: "sessionProfile", label: "UTC session volume", category: "context", availability: "available", source: "Latest UTC-day Gate.io public candles", detail: "Latest UTC-day candle-volume distribution grouped at each candle close. POC and value area are not tick-level volume-at-price or a directional signal." },
  ...
  { id: "largePrints", label: "Large tape prints", category: "flow", availability: "available", source: "Selected bounded public taker-signed trade tape", detail: "Current selected-venue prints meeting a local reported-size threshold. It is not dollar notional, historical tape, cross-venue flow, or a trade signal." },
